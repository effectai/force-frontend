          ...
          <div class="information-block">
            ...
            <div class="p-5">
              ...
              <div class="block is-vcentered">
                ...
                <button v-else-if="batch.status === 'Active' && batch.num_tasks - batch.real_tasks_done !== 0 && !userReservation || releasedReservations.length > 0" class="button is-fullwidth is-primary" @click.prevent="reserveTask = true">
